...
public class TicketCompra {
    ...
    public TicketCompra(LocalDateTime fechaCompra, LocalDate fechaFuncion, double monto, Comprador comprador) {
    ...
    public TicketCompra(int idTicket, LocalDateTime fechaCompra, LocalDate fechaFuncion, double monto, Comprador comprador) {
